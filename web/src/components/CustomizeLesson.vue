<template>
    <div>
        ...
        <div v-if="ready" class="assign-timestamps">
                <h2 id="lessonNameText">New Lesson Name: <input id="lessonNameInput" :value="lessonName"/> </h2>
                <br/><br/>
            ...
            <div id="createLessonButton">
                <button id="customize-lesson-button" @click="newTimestampButtonClick()">Create Lesson</button>
            </div>
        </div>
    </div>
    </template>
