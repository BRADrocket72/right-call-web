...
export function retrieveAndCreateAllVideos() {
  var videoOne = new VideoClip("Basketball Lesson One", 14, "https://d2vue776t14pjd.cloudfront.net/basketball/REG-SE-BSK-PCK-4-DLC/gameplay/P15_Shooting_Foul.m4v", [5.7, 14.4])
  var videoTwo = new VideoClip("Basketball Lesson Two", 14, "https://d2vue776t14pjd.cloudfront.net/basketball/REG-SE-BSK-PCK-4-DLC/gameplay/P15_Shooting_Foul_2.m4v", [8.2, 14])
  var videoThree = new VideoClip("Basketball Lesson Three", 13, "https://d2vue776t14pjd.cloudfront.net/basketball/REG-SE-BSK-PCK-4-DLC/gameplay/P3_Traveling.m4v", [10.3, 13])
  var videoFour = new VideoClip("Basketball Lesson Four", 12, "https://d2vue776t14pjd.cloudfront.net/basketball/REG-SE-BSK-PCK-4-DLC/gameplay/P17_Offensive_Foul.m4v", [6.9, 12])
