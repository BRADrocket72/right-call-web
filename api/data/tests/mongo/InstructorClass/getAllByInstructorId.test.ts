...
beforeEach(async () => {
    ...
    const instructorClassTwo =new InstructorClassSchema({instructorId:"instructor1",className:"Basketball",lessonIds:["id3","id4"],studentIds:["student3","student4"]})
    const instructorClassThree =new InstructorClassSchema({instructorId:"instructor3",className:"Basketball",lessonIds:["id5","id6"],studentIds:["student5","student6"]})
