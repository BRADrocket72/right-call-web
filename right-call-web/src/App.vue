...
export default {
  ...
  data() {
    return {
      sampleVideo: VideoClip,
      ready: false,
    }
  },
  mounted() {
    this.sampleVideo = new VideoClip("sampleVid", 125, "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", [3.7, 14.2, 30.3])
    this.ready = true;
  }
}
</script>
